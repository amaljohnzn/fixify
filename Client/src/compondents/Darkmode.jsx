...
function Darkmode() {
  ...
  return (
    <label className="relative inline-flex items-center cursor-pointer">
      ...
      />
      {/* Toggle Background */}
      <div className="w-12 h-6 bg-black peer-checked:bg-gray-800 rounded-full relative transition-all duration-300">
        {/* Sun Icon (Light Mode) */}
        <svg
        ...
        {/* Moon Icon (Dark Mode) */}
        <svg
          className="absolute right-1 top-1 w-4 h-4 text-white block peer-checked:hidden transition-all "
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
        >
          <g
